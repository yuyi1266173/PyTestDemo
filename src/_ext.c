...
static int _cffi_d_sub(int x0, int x1)
{
  return sub(x0, x1);
}
#ifndef PYPY_VERSION
...
_cffi_f_sub(PyObject *self, PyObject *args)
{
  ...
  if (!PyArg_UnpackTuple(args, "sub", 2, 2, &arg0, &arg1))
    return NULL;
...
#else
#  define _cffi_f_sub _cffi_d_sub
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "add", (void *)_cffi_f_add, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_add },
  { "sub", (void *)_cffi_f_sub, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_sub },
};
